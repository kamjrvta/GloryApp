...
class LogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?)  {
        ...
        binding.lButton.setOnClickListener {
          // startActivity(Intent(this@LogActivity, Dashboard::class.java))
            /*Steps
            * 1) Input Data
            * 2) Validate Data
    ...
    private fun validateData() {
        ...
        //1- Input Data
        email = binding.lEmail.text.toString().trim()
        password = binding.lPassword.text.toString().trim()
